...
void SYS::setup (void) {
  ...
  _PROTECTED_WRITE(CLKCTRL_OSCHFCTRLA,
    #if (F_CPU == 24000000L)
    (CLKCTRL_FREQSEL3_bm | CLKCTRL_FREQSEL0_bm)
    #elif (F_CPU == 20000000L)
    (CLKCTRL_FREQSEL3_bm)
    #elif (F_CPU == 16000000L)
    (CLKCTRL_FREQSEL2_bm | CLKCTRL_FREQSEL1_bm | CLKCTRL_FREQSEL0_bm)
    #elif (F_CPU == 12000000L)
    (CLKCTRL_FREQSEL2_bm | CLKCTRL_FREQSEL1_bm)
    #elif (F_CPU == 8000000L)
    (CLKCTRL_FREQSEL2_bm | CLKCTRL_FREQSEL0_bm)
    #elif (F_CPU == 4000000L)
    (CLKCTRL_FREQSEL1_bm | CLKCTRL_FREQSEL0_bm)
    #elif (F_CPU == 3000000L)
    (CLKCTRL_FREQSEL1_bm)
    #elif (F_CPU == 2000000L)
    (CLKCTRL_FREQSEL0_bm)
  ...
  #if defined(HVEN_PIN_INVERT)
  PIN_CTRL(HVEN_PORT,HVEN_PIN) = PORT_INVEN_bm | PORT_ISC_INPUT_DISABLE_gc;
  #endif
  HVEN_PORT.DIRSET = _BV(HVEN_PIN);
  SYS::hven_disable();

  PIN_CTRL(PGEN_PORT,PGEN_PIN) =
...
inline void SYS::pump_timer_init (void) {
